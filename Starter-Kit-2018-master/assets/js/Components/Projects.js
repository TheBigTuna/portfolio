        ...
        <div className="col-lg-6">
         ...
         {/* <div className="col-lg-6">
          ...
          <div className="col-lg-6">
            ...
            <div className="col-lg-6">
            <a className="portfolio-item" id="p5" href="https://octaviusmoore.com/project4/index.html" target="_blank" onMouseEnter={this.iconDisplay}  onMouseLeave={this.iconHide}>
